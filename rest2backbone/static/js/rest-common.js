/**
 * Common part for rest to backbone
 */
//set CSRF support
...
(function (factory) {
    ...
    var BaseCollection = root.RestBaseCollection = Backbone.Collection.extend({
    ...
    var RestBaseModel = root.RestBaseModel = Backbone.Model.extend({
